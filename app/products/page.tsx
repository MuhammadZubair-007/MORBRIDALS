...
export default function ProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-[#0a2463] to-[#14b8a6] py-12 pt-40 md:pt-48 scroll-animate slide-down" ref={headerRef}>
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white font-serif">All Products</h1>
          <p className="text-lg md:text-xl text-white/90">Browse everything we have in store</p>
        </div>
      </div>
                ...
                >
                  ...
                  <div className="p-4 flex flex-col gap-3 flex-1">
                    <div className="flex flex-col gap-2">
                      ...
                      <Link href={`/product?id=${product._id}`} className="flex items-center gap-2 text-sm">
      ...
      <ShoppingBagSidebar
        ...
        onQuantityChange={(itemId, newQuantity) => {
          const updated = cartItems.map((i) => (i._id === itemId ? { ...i, quantity: newQuantity } : i))
